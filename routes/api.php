...
route::get('/bestseller',[dataController::class,'showbestseller'])->middleware('auth:sanctum');
...
Route::post('/addtocart/{id}', [categoryController::class, 'addcart']);

Route::get('/newcart/{id}', [categoryController::class, 'addtocartg']);

Route::post('/uploadcart', [categoryController::class, 'uploadToCart']);
...
Route::post('/uploadrosheta', [dataController::class, 'uploadrosheta'])->middleware('auth:sanctum');

Route::get('/profile', [dataController::class, 'profile'])->middleware('auth:sanctum');
